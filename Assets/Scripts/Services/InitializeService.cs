...
namespace Services
{
    ...
    {
        public static void Initialize<T>(Transform origin, T obj, bool includeInactive = true)
        {
            origin.GetComponentsInChildren<Initializable<T>>(includeInactive)
                .ToList()
                .ForEach(x => x.Initialize(obj));
        }
        public static void Initialize(Transform origin, bool includeInactive = true)
        {
        ...
        public static void Bind<T>(Transform origin, T obj, bool includeInactive = true)
        {
